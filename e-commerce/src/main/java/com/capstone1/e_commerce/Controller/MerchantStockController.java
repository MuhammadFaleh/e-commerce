...
public class MerchantStockController {
    ...
    public ResponseEntity<?> updateStock(@PathVariable Integer id, @RequestBody @Valid MerchantStock merchant, Errors errors) {
        if (errors.hasErrors()) {
            return ResponseEntity.status(400).body(new ApiResponse(errors.getFieldError().getDefaultMessage()));
        }
    ...
    public ResponseEntity<?> getLowStockID(@PathVariable int threshold, @PathVariable Integer id){
